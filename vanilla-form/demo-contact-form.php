...
define('TO_EMAIL', 'alinabogdanova3003@gmail.com');
...
function sendMessage() {
    ...
    $contact_terms = filter_input(INPUT_POST, 'terms', FILTER_SANITIZE_STRING);
    ...
    // Mail it!
    if ($contact_terms === "true") {
        $result = mail($contact_email, $title, $message, $headers);
    } else {
        $result = true;
    }
