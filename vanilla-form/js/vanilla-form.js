...
var VanillaForm = (function (window) {
    ...
    var VanillaForm = function (form) {
            ...
            self.dict = {
                ...
                "sendSuccess": "Мы получили ваше письмо. Оставайтесь с нами, мы свяжимся с вами в ближайшее время.",
                ...
                "parseResponseError": "Что-то пошло не так. Попробуйте позже или свяжитесь с нами по телефону."
            };
